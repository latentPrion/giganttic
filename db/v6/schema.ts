...
// Full v6 schema: v5 plus TaskMirror, task comments, and task attachment junction tables.
...
export const taskAttachments = sqliteTable(
  ...
  (table) => [
    primaryKey({ columns: [table.projectId, table.taskId, table.attachmentId] }),
    foreignKey({
      columns: [table.projectId, table.taskId],
      foreignColumns: [taskMirror.projectId, taskMirror.taskId],
      name: "TaskAttachments_projectId_taskId_TaskMirror_projectId_taskId_fk",
...
export const taskComments = sqliteTable(
  ...
  (table) => [
    foreignKey({
      columns: [table.projectId, table.taskId],
      foreignColumns: [taskMirror.projectId, taskMirror.taskId],
      name: "TaskComments_projectId_taskId_TaskMirror_projectId_taskId_fk",
    }).onDelete("cascade").onUpdate("cascade"),
  ],
);
...
export const taskCommentsAttachments = sqliteTable(
  ...
  (table) => [
    primaryKey({ columns: [table.projectId, table.taskId, table.commentId, table.attachmentId] }),
    foreignKey({
      columns: [table.projectId, table.taskId],
      foreignColumns: [taskMirror.projectId, taskMirror.taskId],
      name: "TaskComments_Attachments_projectId_taskId_TaskMirror_projectId_taskId_fk",
    }).onDelete("cascade").onUpdate("cascade"),
  ],
);
...
export const taskAttachmentsRelations = relations(taskAttachments, ({ one }) => ({
  ...
  taskMirror: one(taskMirror, {
    fields: [taskAttachments.projectId, taskAttachments.taskId],
    references: [taskMirror.projectId, taskMirror.taskId],
  }),
}));
...
export const taskCommentsRelations = relations(taskComments, ({ one, many }) => ({
  ...
  taskCommentsAttachments: many(taskCommentsAttachments),
  taskMirror: one(taskMirror, {
    fields: [taskComments.projectId, taskComments.taskId],
    references: [taskMirror.projectId, taskMirror.taskId],
  }),
}));
...
export const taskCommentsAttachmentsRelations = relations(
  ...
  ({ one }) => ({
    ...
    taskMirror: one(taskMirror, {
      fields: [taskCommentsAttachments.projectId, taskCommentsAttachments.taskId],
      references: [taskMirror.projectId, taskMirror.taskId],
    }),
  }),
);
