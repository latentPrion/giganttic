...
} from "../discussion/discussion-upload.constants.js";
...
@Injectable()
export class MgrUploadsMultipartInterceptor implements NestInterceptor {
  constructor(
  ...
  intercept(context: ExecutionContext, next: CallHandler): Observable<unknown> {
    ...
    const maxBytes = this.backendConfig.mgrUploadsMaxUploadBytes;
