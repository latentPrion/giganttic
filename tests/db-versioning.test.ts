...
describe("db version selection pipeline", () => {
  ...
  it("advertises v11 as the active schema version", () => {
    ...
    expect(availableSchemaVersions).toContain("v9");
    expect(availableSchemaVersions).toContain("v10");
    expect(availableSchemaVersions).toContain("v11");
    expect(dbTestRuntimeConfig.runtimeSchemaSnapshotSubdir).toBe("v11");
  });
  ...
  it("resolves generated artifact paths from explicit version arguments", () => {
    ...
    expect(getGeneratedSqlDdlDir("v4")).toContain("db/v4/generated-sql-ddl");
    ...
    expect(getGeneratedSqlDdlDir("v9")).toContain("db/v9/generated-sql-ddl");
    expect(getGeneratedSqlDdlDir("v10")).toContain("db/v10/generated-sql-ddl");
    ...
    expect(getGeneratedSqlDdlFilePath("v4")).toContain(
      "db/v4/generated-sql-ddl/schema.sql",
    );
    expect(getGeneratedSqlDdlFilePath("v5")).toContain(
      "db/v5/generated-sql-ddl/schema.sql",
    );
    expect(getGeneratedSqlDdlFilePath("v6")).toContain(
      "db/v6/generated-sql-ddl/schema.sql",
    );
    ...
    expect(getGeneratedSqlDdlFilePath("v9")).toContain(
      "db/v9/generated-sql-ddl/schema.sql",
    );
    expect(getGeneratedSqlDdlFilePath("v10")).toContain(
      "db/v10/generated-sql-ddl/schema.sql",
    );
    expect(getGeneratedSqlDdlDir("v11")).toContain("db/v11/generated-sql-ddl");
    expect(getGeneratedSqlDdlFilePath("v11")).toContain(
      "db/v11/generated-sql-ddl/schema.sql",
    );
  });
