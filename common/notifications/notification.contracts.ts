...
export const NOTIFICATION_EVENT_TYPES = [
  "NOTIFICATION_EVENT_ISSUE_CREATED",
  "NOTIFICATION_EVENT_ISSUE_COMMENT_CREATED",
  "NOTIFICATION_EVENT_ISSUE_COMMENT_MENTIONED",
...
export function getNotificationEventCategory(
  ...
  switch (eventType) {
    case "NOTIFICATION_EVENT_ISSUE_CREATED":
      return "issue-updates";
    case "NOTIFICATION_EVENT_ISSUE_COMMENT_CREATED":
    case "NOTIFICATION_EVENT_TASK_COMMENT_CREATED":
      return "comments";
    case "NOTIFICATION_EVENT_ISSUE_COMMENT_MENTIONED":
    case "NOTIFICATION_EVENT_TASK_COMMENT_MENTIONED":
    case "NOTIFICATION_EVENT_PROJECT_JOURNAL_MENTIONED":
    case "NOTIFICATION_EVENT_ISSUE_JOURNAL_MENTIONED":
    case "NOTIFICATION_EVENT_TASK_JOURNAL_MENTIONED":
      return "mentions";
